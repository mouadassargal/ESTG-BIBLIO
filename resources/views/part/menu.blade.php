<nav class="navbar navbar-expand-lg navbar-dark sticky-top bg-primary shadow-sm">
    ...
    <img src="https://image.winudf.com/v2/image1/ZnNqZXMuYWdhZGlyX2ljb25fMTU1MTYwOTEyM18wNDQ/icon.png?w=170&fakeurl=1" width="30" height="30" class="d-inline-block align-top" alt="">
  Biblio ESTG
  </a>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item ">
        <a class="nav-link" href="{{url('help')}}">Help <span class="sr-only"></span></a>
      </li>
    </ul>
                </div>
